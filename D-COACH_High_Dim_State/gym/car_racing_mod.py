...
FPS         = 50
ZOOM        = 2.0        # Camera zoom 2.7 classic / 2.0
...
class CarRacing(gym.Env):
    ...
    def _render_indicators(self, W, H):
        ...
        #vertical_ind(10,0.01*self.car.wheels[3].omega, (0.2,0,1))s
...
if __name__=="__main__":
    ...
    while True:
        ...
        while True:
            ...
            total_reward += r
            if save_n % 100 == 0 and save_n != 0 and (steps % 2 == 0 or done) and False:
            ...
            if steps % 2 == 0 or done and False:
                ...
                #plt.figure(figsize=(96 / my_dpi, 96 / my_dpi), dpi=my_dpi)
                #plt.imshow(s)
                #plt.savefig("racing_car_database_96x96/test"+str(save_n)+".jpeg", dpi=my_dpi)
                #scipy.misc.imsave('racing_car_database_96x96/test'+str(save_n)+'.jpeg', s)
                #scipy.misc.toimage(s, cmin=0.0, cmax=...).save("racing_car_database_96x96/test"+str(save_n)+".jpeg")
                #plt.close()
                #im = Image.fromarray(s)
                #im.save('racing_car_database_96x96/test'+str(save_n)+'.jpeg')
                save_n += 1
            steps += 1
